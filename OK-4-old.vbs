...
'HIDE THESE FOLDERS
		...
		'CREATE Article
		'///////////////////////////////////
		'''articlefromtext Subfolder.Path,relPath
		'///////////////////////////////////
		'''articlefromhtml Subfolder.Path,relPath
		'///////////////////////////////////
		end if
	...
	hidden=0
		...
		'///////////////////////////////////
		CheckCopyFile objFile,Subfolder
		'///////////////////////////////////
		...
		'///////////////////////////////////
							...
							slide=slide &"<img src='"& relPath & "/"& objFile.Name & "' height='100' width='70' style='float:left;margin:0px 5px 5px 0px'/>"
							End If	
		...
		if hidden=0 then	
			if countsubfolder-countbasefolder=1 then
				...
				objFileA.WriteLine("<tr class='hidden'><td>" & "<a href='" & relPath & "/" & objFile.Name & "' target='_blank' style='text-decoration: none'>"& objFile.Name & "</a>" & "<span class='properties'>"& objFolder.GetDetailsOf(objFolderItem, 3)& "</span>" & "</td> </tr>")
			End If
		end if	
...
objFileA.WriteLine("<tr class='slideshow hidden'><td>" & "<div class='slideshow hidden' >"& slide & "</div></td> </tr>")	
...
Sub HideFiles(Subfolder_Path,objFile_Name)
				...
				'if InStr(objFile_Name,".docx")>0 then	
				...
				End If
							...
							if InStr(objFile_Name,"icon")>0   then
...
'/////////////////////////////
Sub articlefromhtml(Subfolder_Path,Relative_Path)
...
'/////////////////////////////
Sub articlefromtext(Subfolder_Path,Relative_Path)


Set fs = CreateObject("Scripting.FileSystemObject")
						If fs.FileExists(Subfolder_Path & "\"& "icon.txt") Then
						Set MyFile = fs.OpenTextFile(Subfolder_Path & "\"& "icon.txt", ForReading)
...
'//////////////////////////////////
Sub CheckCopyFile(objFile,Subfolder)
